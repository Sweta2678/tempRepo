...
public class JoorOrderStyleItemKeys implements Serializable{
	 ...
	 * @param styletaggroup
	 */
	public JoorOrderStyleItemKeys(Long orderID, String itemNumber, String itemColorCode, String itemSize,
			Long itemStyleId, String styletaggroup) {
		super();
	...
	public int hashCode() {
		...
		result = prime * result + ((styletaggroup == null) ? 0 : styletaggroup.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JoorOrderStyleItemKeys other = (JoorOrderStyleItemKeys) obj;
		...
		if (styletaggroup == null) {
			if (other.styletaggroup != null)
				return false;
		} else if (!styletaggroup.equals(other.styletaggroup))
			return false;
		return true;
	}	
}
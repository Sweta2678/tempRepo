 ...
 */
@Entity
@Table(name = MoicConstant.PRODUCT_MASTER)
@Data
public class ProductMaster implements Serializable {
	 ...
	 * @param modifieDate
	 */
	public ProductMaster(@NotNull String plmUniqueID, String seasonCode, @NotNull String brandID,
			...
			String styleLineDescriptionId, String createdBy, String modifiedBy, Date createDate, Date modifieDate) {
		super();
	...
	public String toString() {
		return "ProductMaster [plmUniqueID=" + plmUniqueID + ", seasonCode=" + seasonCode + ", brandID=" + brandID
				+ ", divisionID=" + divisionID + ", department=" + department + ", styleID=" + styleID
				...
				+ styleLineDescriptionId + ", createdBy=" + createdBy + ", modifiedBy=" + modifiedBy + ", createDate="
				+ createDate + ", modifieDate=" + modifieDate + "]";
	}
}
...
/**
 * The Class SKUChangeReport.
 *
 * @version 0.0.1
 */
@Entity
@Table(name = MoicConstant.SKU_CHANGE_REPORT)
public class SKUChangeReport implements Serializable {
	 ...
	 * @param downloadFlag
	 */
	public SKUChangeReport(Long idAuto, @Size(max = 50) String season, @Size(max = 80) String oldSKU,
			@Size(max = 80) String newSKU, Boolean drop_1, @Size(max = 80) String level, @Size(max = 80) String levelID,
			@Size(max = 80) String sKU, Boolean delete, @Size(max = 50) String soldToNumber,
			...
			int target, Date soHeaderReqDelDate, Date effectiveDate, Date cancelDeliveryDate, Double orderTotalUSD,
			@Size(max = 50) String status, @Size(max = 50) String businessUnit, @Size(max = 50) String fileName,
			@Size(max = 50) String skuClass, Long orderId, String soldToDescription, String width, String country,
			String city, String size, String euSize, String ukSize, Double wholesalePrice, String retailCurrency,
			String wholesaleCurrency, String styleDescription, String userId, String userName, Date createDate,
	...
	public String toString() {
		return "SKUChangeReport [idAuto=" + idAuto + ", season=" + season + ", oldSKU=" + oldSKU + ", newSKU=" + newSKU
				+ ", drop_1=" + drop_1 + ", level=" + level + ", levelID=" + levelID + ", SKU=" + SKU + ", delete="
				+ delete + ", soldToNumber=" + soldToNumber + ", channel=" + channel + ", styleColor=" + styleColor
				...
				+ ", scheduledDeliveryDate=" + scheduledDeliveryDate + ", site=" + site + ", salesDocType="
				...
				+ reqSegment + ", target=" + target + ", soHeaderReqDelDate=" + soHeaderReqDelDate + ", effectiveDate="
				+ effectiveDate + ", cancelDeliveryDate=" + cancelDeliveryDate + ", orderTotalUSD=" + orderTotalUSD
				+ ", status=" + status + ", businessUnit=" + businessUnit + ", fileName=" + fileName + ", SkuClass="
				+ SkuClass + ", orderId=" + orderId + ", soldToDescription=" + soldToDescription + ", width=" + width
				+ ", country=" + country + ", city=" + city + ", size=" + size + ", euSize=" + euSize + ", ukSize="
				+ ukSize + ", wholesalePrice=" + wholesalePrice + ", retailCurrency=" + retailCurrency
				+ ", wholesaleCurrency=" + wholesaleCurrency + ", styleDescription=" + styleDescription + ", userId="

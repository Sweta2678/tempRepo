...
/**
 * The Class FinalizedBuyArchived.
 *
 * @version 0.0.1
 */
@Entity
@Table(name = MoicConstant.FINALIZED_BUY_ARCHIVED)

public class FinalizedBuyArchived implements Serializable {
	 ...
	 * @param orderTotalUSD
	 */
	public FinalizedBuyArchived(Long idAuto, @Size(max = 50) String season, @Size(max = 50) String soldToNumber,
			...
			Date cancelDeliveryDate, String upcCode, String departmentDesc, String classDesc, String subClassCode,
			String subClassDesc, Long orderID, String soldToDescription, String width, String country, String city,
			String size, String userId, String userName, Date createDate, Date modifiedDate, String createdBy,
			String modifiedBy, String source, Date lastDownloadDate, Boolean downloadFlag, Double orderTotalUSD) {
		super();
		this.idAuto = idAuto;
		this.season = season;
	...
	public String toString() {
		return "FinalizedBuyArchived [idAuto=" + idAuto + ", season=" + season + ", soldToNumber=" + soldToNumber
				...
				+ upcCode + ", departmentDesc=" + departmentDesc + ", classDesc=" + classDesc + ", subClassCode="
				+ subClassCode + ", subClassDesc=" + subClassDesc + ", orderID=" + orderID + ", soldToDescription="
				+ soldToDescription + ", width=" + width + ", country=" + country + ", city=" + city + ", size=" + size
				+ ", userId=" + userId + ", userName=" + userName + ", createDate=" + createDate + ", modifiedDate="
				+ modifiedDate + ", createdBy=" + createdBy + ", modifiedBy=" + modifiedBy + ", source=" + source
				+ ", lastDownloadDate=" + lastDownloadDate + ", downloadFlag=" + downloadFlag + ", orderTotalUSD="
				+ orderTotalUSD + "]";
	}

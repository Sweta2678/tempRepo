...
/**
 * The Class FinalizedBuy.
 *
 * @version 0.0.1
 */
@Entity
@Table(name = MoicConstant.FINALIZED_BUY)
@IdClass(FinalizedBuyKeys.class)
public class FinalizedBuy implements Serializable {
	...
	@Column(name = MoicConstant.JOOR_ORDER_TYPE)	
	private String joorOrderType;
	...
	@Column(name = MoicConstant.DEPARTMENT_DESCRIPTION, length = 100)
	private String departmentDesc;
	
	@Column(name = MoicConstant.CLASS_DESCRIPTION, length = 100)
	private String classDesc;
	
	@Column(name = MoicConstant.SUB_CLASS_CODE, length = 100)
	private String subClassCode;
	
	@Column(name = MoicConstant.SUB_CLASS_DESCRIPTION, length = 100)
	...
	@Column(name = MoicConstant.RETAIL_CURRENCY)
	private String retailCurrency;
	
	@Column(name = MoicConstant.WHOLESALE_CURRENCY)
	 ...
	 * @param retailCurrency
	 * @param wholesaleCurrency
	 * @param userId
	 * @param userName
	 * @param createDate
	 * @param modifiedDate
	 ...
	 * @param downloadFlag
	 */
	public FinalizedBuy(@Size(max = 50) String season, @Size(max = 50) String soldToNumber,
			@Size(max = 80) String oldSKU, @Size(max = 80) String newSKU, Long orderID, Date uploadDate,
			...
			Date cancelDeliveryDate, String joorOrderType, Double orderTotalUSD, String upcCode, String departmentDesc,
			String classDesc, String subClassCode, String subClassDesc, String soldToDescription, String width,
			String country, String city, String size, String euSize, String ukSize, Double wholesalePrice,
			String retailCurrency, String wholesaleCurrency, String userId, String userName, Date createDate,
			Date modifiedDate, String createdBy, String modifiedBy, String source, Date lastDownloadDate,
		...
		this.joorOrderType = joorOrderType;
	...
	public String getJoorOrderType() {
		return joorOrderType;
	}

	public void setJoorOrderType(String joorOrderType) {
		this.joorOrderType = joorOrderType;
	}
	...
	public String toString() {
		return "FinalizedBuy [season=" + season + ", soldToNumber=" + soldToNumber + ", oldSKU=" + oldSKU + ", newSKU="
				+ newSKU + ", orderID=" + orderID + ", uploadDate=" + uploadDate + ", channel=" + channel
				...
				+ ", effectiveDate=" + effectiveDate + ", cancelDeliveryDate=" + cancelDeliveryDate + ", joorOrderType="
				+ joorOrderType + ", orderTotalUSD=" + orderTotalUSD + ", upcCode=" + upcCode + ", departmentDesc="
				+ departmentDesc + ", classDesc=" + classDesc + ", subClassCode=" + subClassCode + ", subClassDesc="
				+ subClassDesc + ", soldToDescription=" + soldToDescription + ", width=" + width + ", country="
				+ country + ", city=" + city + ", size=" + size + ", euSize=" + euSize + ", ukSize=" + ukSize
				+ ", wholesalePrice=" + wholesalePrice + ", retailCurrency=" + retailCurrency + ", wholesaleCurrency="
				+ wholesaleCurrency + ", userId=" + userId + ", userName=" + userName + ", createDate=" + createDate

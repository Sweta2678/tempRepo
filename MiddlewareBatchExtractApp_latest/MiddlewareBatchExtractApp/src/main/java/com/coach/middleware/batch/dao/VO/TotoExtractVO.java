...
public class TotoExtractVO implements Cloneable{
	...
	private String totoCountryofOrigin;
	...
	private String totoLengthIn;
	private String totoHeightIn;
	private String totoWidthIn;
	...
	private String totoStrapLengthInInch;
	private String totoDropLengthInInch;
	...
	private String totoExteriaorPocket;
	private String closures;
	private String creditCardPocket;
	private String totoBillfoldPocket;
	...
	//private TotoExtractDTO totoExtractDTO;
	...
	public String getTotoCountryofOrigin() {
		return totoCountryofOrigin;
	}
	public void setTotoCountryofOrigin(String totoCountryofOrigin) {
		this.totoCountryofOrigin = totoCountryofOrigin;
	}
	...
	public String getTotoLengthcm() {
		return totoLengthcm;
	}
	public void setTotoLengthcm(String totoLengthcm) {
		this.totoLengthcm = totoLengthcm;
	}
	public String getTotoHeightcm() {
		return totoHeightcm;
	}
	public void setTotoHeightcm(String totoHeightcm) {
		this.totoHeightcm = totoHeightcm;
	}
	public String getTotoWidthcm() {
		return totoWidthcm;
	}
	public void setTotoWidthcm(String totoWidthcm) {
		this.totoWidthcm = totoWidthcm;
	}
	
	public String getTotoLengthIn() {
		return totoLengthIn;
	}
	public void setTotoLengthIn(String totoLengthIn) {
		this.totoLengthIn = totoLengthIn;
	}
	public String getTotoHeightIn() {
		return totoHeightIn;
	}
	public void setTotoHeightIn(String totoHeightIn) {
		this.totoHeightIn = totoHeightIn;
	}
	public String getTotoWidthIn() {
		return totoWidthIn;
	}
	public void setTotoWidthIn(String totoWidthIn) {
		this.totoWidthIn = totoWidthIn;
	}
	...
	public String getTotoStrapLengthIn() {
		return totoStrapLengthIn;
	}
	public void setTotoStrapLengthIn(String totoStrapLengthIn) {
		this.totoStrapLengthIn = totoStrapLengthIn;
	}
	public String getTotoDropLengthIn() {
		return totoDropLengthIn;
	}
	public void setTotoDropLengthIn(String totoDropLengthIn) {
		this.totoDropLengthIn = totoDropLengthIn;
	}
	
	public String getTotoStrapLengthInInch() {
		return totoStrapLengthInInch;
	}
	public void setTotoStrapLengthInInch(String totoStrapLengthIn) {
		this.totoStrapLengthInInch = totoStrapLengthIn;
	}
	public String getTotoDropLengthInInch() {
		return totoDropLengthInInch;
	}
	public void setTotoDropLengthInInch(String totoDropLengthIn) {
		this.totoDropLengthInInch = totoDropLengthIn;
	}
	...
	public String getTotoExteriaorPocket() {
		return totoExteriaorPocket;
	}
	public void setTotoExteriaorPocket(String totoExteriaorPocket) {
		this.totoExteriaorPocket = totoExteriaorPocket;
	}
	...
	public String getTotoBillfoldPocket() {
		return totoBillfoldPocket;
	}
	public void setTotoBillfoldPocket(String totoBillfoldPocket) {
		this.totoBillfoldPocket = totoBillfoldPocket;
	}
	...
	public void setFactoryStoreTypeProduct(String factoryStoreTypeProduct) {
		FactoryStoreTypeProduct = factoryStoreTypeProduct;
	}
	...
	/*public TotoExtractDTO getTotoExtractDTO() {
		return totoExtractDTO;
	}
	public void setTotoExtractDTO(TotoExtractDTO totoExtractDTO) {
		this.totoExtractDTO = totoExtractDTO;
	}*/
